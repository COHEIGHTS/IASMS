...
if(isset($_POST["btn_submit"])){
	...
	if($execute_mysql_query1 = mysqli_query($conn,$mysql_query1)){
		...
		$mysql_query4 = "SELECT * FROM internal_registration WHERE index_number='$student_index_number'";
		...
		if($check_existence2==1){
			$mysql_query5 = "UPDATE `internal_registration` SET `visiting_supervisor_grade` = '$grade_score' WHERE index_number = '$student_index_number'";
