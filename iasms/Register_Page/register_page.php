...
<body>
        ...
        <div class="col-lg-6">
          <div class="panel">
            <div class="panel-body pbody pbody_vira">
              <span>In case you have decided to do your Industrial
                Attachment in the Univeristy,<br><em style="font-weight:bold;color:#2B3775"> Please Click On The
                  Button Below </em></span>
              <br><br>
        ...
        <div class="col-lg-6">
          <div class="panel">
            <div class="panel-body pbody pbody_industrial">
              <span>In case you are interning with a company or institution other than the University,<br><em
                  style="font-weight:bold;color:#2B3775"> Please Click On The Button Below </em></span>
              <br><br>
              <button type="button" class="btn btn-primary btn-medium" style="padding:10px;color:white"
  ...
  $(document).ready(function() {
    $("#btn_vira").click(function() {
      var url = "internal_registration_page.php";
