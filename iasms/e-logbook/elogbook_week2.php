...
$stmt = $conn->prepare("SELECT * FROM week2_table WHERE index_number = ? LIMIT 1");
...
if (isset($_POST["btn_save"]) || isset($_POST["btn_update"])) {
    ...
    if (!empty($monday_job_assigned) && !empty($monday_skill_acquired) &&
        ...
        if (isset($_POST["btn_save"]) && !$is_existing_data) {
            // Insert new data
            $stmt = $conn->prepare("INSERT INTO `week2_table` (`username`, `index_number`, `monday_job_assigned`, `monday_special_skill_acquired`, `tuesday_job_assigned`, `tuesday_special_skill_acquired`, `wednesday_job_assigned`, `wednesday_special_skill_acquired`, `thursday_job_assigned`, `thursday_special_skill_acquired`, `friday_job_assigned`, `friday_special_skill_acquired`, `date`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
    ...
    <div class="container-fluid">
      <div class="panel">
        <div class="panel-heading phead">
          <h2 class="panel-title ptitle">E-LogBook - Week 2</h2>
        </div>
        <div class="panel-body pbody">
          <div id="navigation_holder">
            <ul class="pager">
              <li class="previous"><a href="elogbook.php">← Previous</a></li>
              <li class="next"><a href="elogbook_week3.php">Next →</a></li>
            </ul>
          </div>
          <form id="elogbook_week2_form" method="post">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th>Day</th>
                  <th>Job Assigned</th>
                  <th>Special Skills Acquired</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>Monday</td>
                  <td><input type="text" name="job_assigned_1" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($monday_job_assigned_holder); ?>" /></td>
                  <td><input type="text" name="skill_acquired_1" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($monday_skill_acquired_holder); ?>" /></td>
                </tr>
                <tr>
                  <td>Tuesday</td>
                  <td><input type="text" name="job_assigned_2" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($tuesday_job_assigned_holder); ?>" /></td>
                  <td><input type="text" name="skill_acquired_2" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($tuesday_skill_acquired_holder); ?>" /></td>
                </tr>
                <tr>
                  <td>Wednesday</td>
                  <td><input type="text" name="job_assigned_3" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($wednesday_job_assigned_holder); ?>" /></td>
                  <td><input type="text" name="skill_acquired_3" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($wednesday_skill_acquired_holder); ?>" /></td>
                </tr>
                <tr>
                  <td>Thursday</td>
                  <td><input type="text" name="job_assigned_4" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($thursday_job_assigned_holder); ?>" /></td>
                  <td><input type="text" name="skill_acquired_4" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($thursday_skill_acquired_holder); ?>" /></td>
                </tr>
                <tr>
                  <td>Friday</td>
                  <td><input type="text" name="job_assigned_5" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($friday_job_assigned_holder); ?>" /></td>
                  <td><input type="text" name="skill_acquired_5" class="form-control elogbook_inputs"
                      value="<?php echo htmlspecialchars($friday_skill_acquired_holder); ?>" /></td>
                </tr>
              </tbody>
            </table>

            <div id="btn_holder">
              <button class="btn btn-success" name="btn_update" id="btn_update"
                <?php echo $btn_update_status; ?>>Update</button>
              <button class="btn btn-primary" name="btn_save" id="btn_save"
