    ...
    if ($search_by != "" && $search_term != "" && $search_by != "Filter By") {
        switch ($search_by) {
            ...
            case 'Session':
                ...
                break;
            case 'Score':
                $mysql_query_1 = "SELECT * FROM internal_registration WHERE visiting_supervisor_grade LIKE '%$search_term%'";
...
$total_query_1 = "SELECT COUNT(*) FROM internal_registration" . (strpos($mysql_query_1, 'WHERE') ? strstr($mysql_query_1, 'WHERE', true) : '');
$total_query_2 = "SELECT COUNT(*) FROM industrial_registration" . (strpos($mysql_query_2, 'WHERE') ? strstr($mysql_query_2, 'WHERE', true) : '');
...
<body>
  ...
  <div id="left_side_bar">
    <ul id="menu_list">
      ...
      <a class="menu_items_link" href="visiting_supervisors_score.php">
        <li class="menu_items_list" style="background-color:orange;padding-left:16px">Visiting Supervisors Score</li>
      </a>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th style="text-align:center">Visiting Supervisor Score</th>
                </tr>
              </thead>
              <tbody>
                <?php
